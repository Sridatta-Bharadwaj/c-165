AFRAME.registerComponent("enemy-bullets", {
    ...
    shootEnemyBullet: function () {
        ...
        for (var i = 0; i < els.length; i++) {           
            ...
            var el = document.querySelector("#countTank");
            var tankCount = parseInt(element.getAttribute("text").value);
            ...
            bullets.addEventListener("collide", function (e) {
                if (e.detail.body.el.id = tankEl[i]) {
                    tankCount -= 1;
